<main>
                ...
                <div class="offset-lg-1 col-lg-6 col-12">
                    <div class="position-relative z-1 pt-lg-9" data-cue="slideInRight">
                        <div class="position-relative">
                            <img src="{{ asset('images/landings/finance/finance-hero-side-img.jpg') }}" alt="video" class="img-fluid rounded-3" width="837" />
                            <a
                            ...
                            <div class="swiper-slide">
                                <div data-cue="slideInDown">
                                    <figure class="text-center">
                                        <img src="{{ asset('images/client-logo/clients-logo-1.svg') }}" alt="logo" />
                                    </figure>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div data-cue="slideInDown">
                                    <figure class="text-center">
                                        <img src="{{ asset('images/client-logo/clients-logo-2.svg') }}" alt="logo" />
                                    </figure>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div data-cue="slideInDown">
                                    <figure class="text-center">
                                        <img src="{{ asset('images/client-logo/clients-logo-3.svg') }}" alt="logo" />
                                    </figure>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div data-cue="slideInDown">
                                    <figure class="text-center">
                                        <img src="{{ asset('images/client-logo/clients-logo-4.svg') }}" alt="logo" />
                                    </figure>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div data-cue="slideInDown">
                                    <figure class="text-center">
                                        <img src="{{ asset('images/client-logo/clients-logo-5.svg') }}" alt="logo" />
                                    </figure>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card border-0 card-primary">
                            <div class="card-body p-5">
                                <div class="position-relative d-inline-block mb-5">
                                    <img
                                        src="{{ asset('images/landings/finance/feature-img-1.jpg') }}"
                                        alt="feature"
                                        class="avatar avatar-xl rounded-circle border-2 border border-white shadow-sm" />
                    ...
                    <div class="col-lg-4 col-md-6" data-cue="zoomIn">
                        <div class="card border-0 card-primary">
                            <div class="card-body p-5">
                                <div class="position-relative d-inline-block mb-5">
                                    <img
                                        src="{{ asset('images/landings/finance/feature-img-2.jpg') }}"
                                        alt="feature"
                                        class="avatar avatar-xl rounded-circle border-2 border border-white shadow-sm" />
                    ...
                    <div class="col-lg-4 col-md-6" data-cue="zoomIn">
                        <div class="card border-0 card-primary">
                            <div class="card-body p-5">
                                <div class="position-relative d-inline-block mb-5">
                                    <img
                                        src="{{ asset('images/landings/finance/feature-img-3.jpg') }}"
                                        alt="feature"
                                        class="avatar avatar-xl rounded-circle border-2 border border-white shadow-sm" />
                        ...
                        <a
                            ...
                            <div class="ms-4">
                                ...
                                <p class="mb-0 mt-lg-3 d-none d-lg-block">
                                    Interdum et malesuad a fames ac ante ipsum primis in faucibus. Simple dummy content. Sed lacinia gsmod dui euismod id.
                                </p>
                            </div>
                        </a>
                        <a
                            ...
                            <div class="ms-4">
                                ...
                                <p class="mb-0 mt-lg-3 d-none d-lg-block">
                                    Nullam sodales, libero ac dictum convallis, ipsum diam cursus stibulum lacinia ultricies eleifend. Simple dummy content.
                                </p>
                            </div>
                        </a>
                        <a
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-small-business" role="tabpanel" aria-labelledby="v-pills-small-business-tab" tabindex="0">
                            <div class="position-relative scene" data-relative-input="true">
                                <figure><img src="{{ asset('images/landings/finance/finance-tab-3.jpg') }}" alt="finance" class="img-fluid rounded-3" data-cue="fadeIn" /></figure>

                                <div class="position-relative" data-depth="0.05">
                                    <img src="{{ asset('images/landings/finance/card.svg') }}" alt="" class="position-absolute bottom-0 end-0 px-4" />
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab" tabindex="0">
                            <div class="position-relative scene" data-relative-input="true">
                                <figure><img src="{{ asset('images/landings/finance/finance-tab-2.jpg') }}" alt="finance" class="img-fluid rounded-3" data-cue="fadeIn" /></figure>

                                <div class="position-relative" data-depth="0.05">
                                    <img src="{{ asset('images/landings/finance/card.svg') }}" alt="" class="position-absolute bottom-0 start-0 px-4" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-enterprises" role="tabpanel" aria-labelledby="v-pills-enterprises-tab" tabindex="0">
                            <div class="position-relative scene" data-relative-input="true">
                                <figure><img src="{{ asset('images/landings/finance/finance-tab-1.jpg') }}" alt="finance" class="img-fluid rounded-3" /></figure>

                                <div class="position-relative" data-depth="0.05">
                                    <img src="{{ asset('images/landings/finance/card.svg') }}" alt="" class="position-absolute bottom-0 start-50 translate-middle-x" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-md-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center mb-3 mb-lg-0">
                                    <div>
                                        <img src="{{ asset('images/avatar/avatar-1.jpg') }}" alt="Avatar" class="avatar avatar-lg rounded-circle" />
                                    </div>
                                    <div class="ms-3">
                                ...
                                <div class="d-none d-md-block text-inverse">
                                    <img src="{{ asset('images/client-logo/logoipsum-1.svg') }}" alt="logo" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="card shadow-sm" data-cue="slideInRight">
                        <div class="card-body">
                            <p class="mb-5 lead">
                                "Cum molestias sed quam eos repudiandae repellat! Sunt ex atque tempore eligendi magni vel obcaecati facere. Cupiditate repellat deleniti eos eum atque possimus
                                ducimus quis."
                            </p>
                            <div class="d-md-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center mb-3 mb-lg-0">
    ...
    <section>
        <div
            style="background-image: url({{ asset('images/pattern/cta-pattern.png') }}); background-position: center; background-repeat: no-repeat; background-size: cover"
